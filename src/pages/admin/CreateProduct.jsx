...
const CreateProduct = () => {
    ...
    const handleCreate = async () => {
        try {
            ...
            let { data } = await axios.post(`${process.env.REACT_APP_BACKEND_URL}/api/v1/product/create-product`, productData);
            if (data?.success) {
                        ...
                        loading ? (<PageLoaderSpinner left={63} />) :
                            (
                                <div className="col-md-9">
                                    <h2 className='text-center text-primary'>Create Product</h2>
